<template>
    ...
    <section class="board-pages Main ">
        <div class="header">
            <span class="text-left fs-3 fw-bold">اضافة دولة جديده</span>
        </div>
        ...
        <div class="d-flex justify-content-end  mt-5 ">
            <button class="btn btn-primary save"  :disabled="checkDisabled" @click="AddToList">حفظ</button>
            <router-link to="/dashboard/countries" class="btn btn-primary cancel">الغاء</router-link>
        </div>
    </section>   
    <footer-view></footer-view>
    <base-dialog :show="showDialog">
        <strong>تم الستجيل بنجاح</strong>
    </base-dialog>
</template>
<script>
